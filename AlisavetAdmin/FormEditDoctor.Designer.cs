...
namespace AlisavetAdmin
{
    partial class FormEditDoctor
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormEditDoctor));
            ...
            this.middlenameLabel.TabIndex = 47;
            // 
            // nameLabel
            // 
            ...
            this.button2.Text = "Изменить врача";
            ...
            this.Text = "Изменить врача";
            this.Load += new System.EventHandler(this.FormEditDoctor_Load);
